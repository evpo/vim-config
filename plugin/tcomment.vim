...
noremap <Plug>TComment_<c--><c--> :TComment<cr>
vnoremap <Plug>TComment_<c--><c--> :TCommentMaybeInline<cr>
inoremap <Plug>TComment_<c--><c--> <c-o>:TComment<cr>
noremap <Plug>TComment_<c-->p m`vip:TComment<cr>``
inoremap <Plug>TComment_<c-->p <c-o>:norm! m`vip<cr>:TComment<cr><c-o>``
noremap <Plug>TComment_<c--><space> :TComment 
inoremap <Plug>TComment_<c--><space> <c-o>:TComment 
inoremap <Plug>TComment_<c-->r <c-o>:TCommentRight<cr>
noremap <Plug>TComment_<c-->r :TCommentRight<cr>
vnoremap <Plug>TComment_<c-->i :TCommentInline<cr>
noremap <Plug>TComment_<c-->i v:TCommentInline mode=I#<cr>
inoremap <Plug>TComment_<c-->i <c-\><c-o>v:TCommentInline mode=#<cr>
noremap <Plug>TComment_<c-->b :TCommentBlock<cr>
inoremap <Plug>TComment_<c-->b <c-\><c-o>:TCommentBlock mode=#<cr>
noremap <Plug>TComment_<c-->a :TCommentAs 
inoremap <Plug>TComment_<c-->a <c-o>:TCommentAs 
noremap <Plug>TComment_<c-->n :TCommentAs <c-r>=&ft<cr> 
inoremap <Plug>TComment_<c-->n <c-o>:TCommentAs <c-r>=&ft<cr> 
noremap <Plug>TComment_<c-->s :TCommentAs <c-r>=&ft<cr>_
inoremap <Plug>TComment_<c-->s <c-o>:TCommentAs <c-r>=&ft<cr>_
noremap <Plug>TComment_<c-->cc :<c-u>call tcomment#SetOption("count", v:count1)<cr>
noremap <Plug>TComment_<c-->ca :<c-u>call tcomment#SetOption("as", input("Comment as: ", &filetype, "customlist,tcomment#Complete"))<cr>
...
for s:i in range(1, 9)
    exec 'noremap <Plug>TComment_<c-->' . s:i . ' :call tcomment#SetOption("count", '. s:i .')<cr>'
    exec 'inoremap <Plug>TComment_<c-->' . s:i . ' <c-\><c-o>:call tcomment#SetOption("count", '. s:i .')<cr>'
    exec 'vnoremap <Plug>TComment_<c-->' . s:i . ' :call tcomment#SetOption("count", '. s:i .')<cr>'
endfor
for s:i in range(1, 9)
...
if g:tcommentMaps
    if g:tcommentMapLeader1 != ''
        exec 'map '. g:tcommentMapLeader1 . g:tcommentMapLeader1 .' <Plug>TComment_<c--><c-->'
        exec 'vmap '. g:tcommentMapLeader1 . g:tcommentMapLeader1 .' <Plug>TComment_<c--><c-->'
        exec 'imap '. g:tcommentMapLeader1 . g:tcommentMapLeader1 .' <Plug>TComment_<c--><c-->'
        exec 'map '. g:tcommentMapLeader1 .'p <Plug>TComment_<c-->p'
        exec 'imap '. g:tcommentMapLeader1 .'p <Plug>TComment_<c-->p'
        exec 'map '. g:tcommentMapLeader1 .'<space> <Plug>TComment_<c--><space>'
        exec 'imap '. g:tcommentMapLeader1 .'<space> <Plug>TComment_<c--><space>'
        exec 'imap '. g:tcommentMapLeader1 .'r <Plug>TComment_<c-->r'
        exec 'map '. g:tcommentMapLeader1 .'r <Plug>TComment_<c-->r'
        exec 'vmap '. g:tcommentMapLeader1 .'i <Plug>TComment_<c-->i'
        exec 'map '. g:tcommentMapLeader1 .'i <Plug>TComment_<c-->i'
        exec 'imap '. g:tcommentMapLeader1 .'i <Plug>TComment_<c-->i'
        exec 'map '. g:tcommentMapLeader1 .'b <Plug>TComment_<c-->b'
        exec 'imap '. g:tcommentMapLeader1 .'b <Plug>TComment_<c-->b'
        exec 'map '. g:tcommentMapLeader1 .'a <Plug>TComment_<c-->a'
        exec 'imap '. g:tcommentMapLeader1 .'a <Plug>TComment_<c-->a'
        exec 'map '. g:tcommentMapLeader1 .'n <Plug>TComment_<c-->n'
        exec 'imap '. g:tcommentMapLeader1 .'n <Plug>TComment_<c-->n'
        exec 'map '. g:tcommentMapLeader1 .'s <Plug>TComment_<c-->s'
        exec 'imap '. g:tcommentMapLeader1 .'s <Plug>TComment_<c-->s'
        exec 'map '. g:tcommentMapLeader1 .'cc <Plug>TComment_<c-->cc'
        exec 'map '. g:tcommentMapLeader1 .'ca <Plug>TComment_<c-->ca'
        for s:i in range(1, 9)
            exec 'map '. g:tcommentMapLeader1 . s:i .' <Plug>TComment_<c-->'.s:i
            exec 'imap '. g:tcommentMapLeader1 . s:i .' <Plug>TComment_<c-->'.s:i
            exec 'vmap '. g:tcommentMapLeader1 . s:i .' <Plug>TComment_<c-->'.s:i
        endfor
        unlet s:i
    endif
